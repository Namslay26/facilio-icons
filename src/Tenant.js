...
const SvgTenant = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Tenant_svg__clip-path">
        <path
      ...
      <style>{".Tenant_svg__cls-3{fill:#334056}"}</style>
    </defs>
    <g id="Tenant_svg__trim_area" data-name="trim area">
      <path
