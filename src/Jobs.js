...
const SvgJobs = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <defs>
      <style>{".Jobs_svg__cls-2{fill:#334056}"}</style>
    </defs>
    <g id="Jobs_svg__trim_area" data-name="trim area">
      <path
      ...
      />
      <path
        className="Jobs_svg__cls-2"
        d="m64.44 31.89 3.87 7.86 8.67 1.26-6.27 6.11 1.48 8.63-7.75-4.07-7.76 4.07 1.48-8.63-6.27-6.11 8.67-1.26 3.88-7.86zM140.06 48H92a4 4 0 0 1 0-8h48.07a4 4 0 1 1 0 8ZM140.06 64.06H92a4 4 0 0 1 0-8h48.07a4 4 0 0 1 0 8ZM140.06 80.09H92a4 4 0 1 1 0-8h48.07a4 4 0 0 1 0 8Z"
      />
    </g>
  </svg>
);
