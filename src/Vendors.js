...
const SvgVendors = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      <clipPath id="Vendors_svg__clip-path">
        <path
      ...
      <style>{".Vendors_svg__cls-4{fill:none}"}</style>
    </defs>
    <g id="Vendors_svg__trim_area" data-name="trim area">
      <path
      ...
      />
      <path className="Vendors_svg__cls-4" d="M0 0h192v192H0z" />
      <path className="Vendors_svg__cls-4" d="M0 0h192v192H0z" />
    </g>
  </svg>
);
