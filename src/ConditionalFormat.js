...
const SvgConditionalformat = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <g id="conditional_format_svg__trim_area" data-name="trim area">
      ...
      <path
        className="conditional_format_svg__cls-1"
        d="m142.16 97.33-53.8-53.66.07-.07 53.73 53.73zM172.31 155.8c-1.59 6-7 14.5-14.5 14.5s-12.92-8.47-14.5-14.5c-2.66-10.1 3.06-22 14.5-29.93 11.44 7.9 17.19 19.83 14.5 29.93Z"
      />
      <path
        style={{
          fill: "none",
